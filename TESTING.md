...
- Self-closing syntax warnings on void elements  
  → Left unchanged where generated by Django templates (HTML5-compliant and non-blocking).

After these fixes, all validated pages returned **no errors or warnings**.
...
### Result
✔ All tested HTML pages pass W3C validation with **no errors or warnings**.
